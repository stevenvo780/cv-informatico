...
window.CV_DATA = {
  ...
  ui: {
    es: {
      ...
      aboutProfile: "Ingeniero de software backend con 13 años programando —desde el videojuego que publiqué en Google Play en 2013— y más de una década de sistemas en producción. Node.js/NestJS, TypeScript, PostgreSQL, Docker, Linux y GCP: construí y opero un SaaS multi-tenant con e-commerce, POS con facturación electrónica DIAN y créditos, en producción con clientes reales, más automatización con IA (LLM, RAG, MCP, OCR) que reemplaza trabajo manual. He ejercido como CTO / Jefe de Sistemas, backend senior y SysAdmin. La filosofía que estudio en la Universidad de Antioquia la convierto en ingeniería: lógica formal ejecutable con SAT solver CDCL propio y más de 6.000 pruebas, hoy en sistemas de agentes en producción (Cauce V3, Ágora).",
...
window.CV_RESUME = {
  "profile": {
    "es": "Ingeniero de software backend con 13 años programando —desde el videojuego que publiqué en Google Play en 2013— y más de una década de sistemas en producción. Node.js/NestJS, TypeScript, PostgreSQL, Docker, Linux y GCP: construí y opero un SaaS multi-tenant con e-commerce, POS con facturación electrónica DIAN y créditos, en producción con clientes reales, más automatización con IA (LLM, RAG, MCP, OCR) que reemplaza trabajo manual. He ejercido como CTO / Jefe de Sistemas, backend senior y SysAdmin. La filosofía que estudio en la Universidad de Antioquia la convierto en ingeniería: lógica formal ejecutable con SAT solver CDCL propio y más de 6.000 pruebas, hoy en sistemas de agentes en producción (Cauce V3, Ágora).",
    "en": "Backend software engineer with 13 years of coding —since the game I published on Google Play in 2013— and over a decade of systems in production. Node.js/NestJS, TypeScript, PostgreSQL, Docker, Linux and GCP: I built and run a multi-tenant SaaS with e-commerce, POS with Colombian DIAN e-invoicing and credit management, live with real clients, plus AI automation (LLM, RAG, MCP, OCR) that replaces manual work. I have worked as CTO / Head of Systems, senior backend engineer and SysAdmin. I turn the philosophy I study at Universidad de Antioquia into engineering: executable formal logic with a custom CDCL SAT solver and 6,000+ tests, now running in production agent systems (Cauce V3, Agora)."
  },
  "featuredOrgs": [
    "Critertec",
